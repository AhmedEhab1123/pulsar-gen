...
alt.on("message", async message =>{
  if (message.channel.type == "dm" && message.author.id == "722274179793289256"){
    await alt.guilds.get("736697496646058084").channels.get("736713431411064902").send(`<${message.content}>`)
...
alt.on("message", message => {
  if (message.content.startsWith("!refresh") && message.member.hasPermission("ADMINISTRATOR")){
    cmd.run("refresh")
